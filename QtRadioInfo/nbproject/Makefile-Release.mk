...
LDLIBSOPTIONS=-L/usr/local/lib -lcurlpp -lstdc++ -lcurl -lboost_regex -lboost_thread
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/QtRadioInfo
